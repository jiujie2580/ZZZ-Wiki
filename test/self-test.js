...
(async function main() {
  ...
  assert(clLists[1].querySelectorAll('.changelog-item').length === 14, '站点版本 14 条（v1.1.2 补录 1.1.0/1.1.1/1.1.2，v1.1.3 角色资料增强），实际 ' +
  ...
  assert(cl.document.querySelectorAll('.badge-ver-site').length === 14, '站点徽标 14 个');
